...
# 05Sep22 (fp215)
# 26Oct22 (fp215) - updates using separated AF & RE datasets + updated sample info. Differentiated samples already removed from the RE dataset.
# 
# Folders required:
#     - NORMALISED_COUNTS
...
#
# Files required:
#     - Howell raw counts dataset: /home/fp215/rds/rds-fp215-working/RNASEQ/NLRC5_PAPER/RAW_COUNTS/Howell_GRCh37_RawCounts.RData
#     - RE raw counts dataset: /home/fp215/rds/rds-fp215-working/RNASEQ/NLRC5_PAPER/RAW_COUNTS/RE_GRCh37_RawCounts.RData
#     - AF raw counts dataset: /home/fp215/rds/rds-fp215-working/RNASEQ/NLRC5_PAPER/RAW_COUNTS/AF_GRCh37_RawCounts.RData
#
# Functions used:
...
load("RAW_COUNTS/Howell_GRCh37_RawCounts.RData")

readme.howell.raw

# RE DATASET:

load("RAW_COUNTS/RE_GRCh37_RawCounts.RData")

readme.re.raw

# AF DATASET:

load("RAW_COUNTS/AF_GRCh37_RawCounts.RData")
...
save(raw.howell,pheno.howell,raw.howell.ti,pheno.howell.ti,raw.howell.sc,pheno.howell.sc,raw.howell.ac,pheno.howell.ac,info,readme.howell.raw,file="RAW_COUNTS/Howell_GRCh37_RawCounts.RData")
...
save(raw.re.all,pheno.re.all,raw.re,pheno.re,info,raw.re.ti,pheno.re.ti,raw.re.sc,pheno.re.sc,readme.re.raw,file="RAW_COUNTS/RE_GRCh37_RawCounts.RData")
...
save(raw.af,pheno.af,info,raw.af.ti,pheno.af.ti,raw.af.sc,pheno.af.sc,raw.af.duo,pheno.af.duo,readme.af.raw,file="RAW_COUNTS/AF_GRCh37_RawCounts.RData")
...
pdf("RAW_COUNTS_QC/HOWELL_GRCh37/Howell_GRCh37_TI_RawCounts_HeatScree.pdf", width=10, height=6)
...
pdf("RAW_COUNTS_QC/HOWELL_GRCh37/Howell_GRCh37_SC_RawCounts_HeatScree.pdf", width=10, height=6)
heat.scree(Loadings, Importance, 2.5, 2.7)
dev.off()
...
pdf("RAW_COUNTS_QC/HOWELL_GRCh37/Howell_GRCh37_AC_RawCounts_HeatScree.pdf", width=10, height=6)
heat.scree(Loadings, Importance, 2.5, 2.7)
dev.off()
...
pdf("RAW_COUNTS_QC/RE_GRCh37/RE_GRCh37_UndifferentiatedTI_RawCounts_HeatScree.pdf", width=10, height=7)
heat.scree(Loadings, Importance, 2.5, 2.7)
dev.off()
...
pdf("RAW_COUNTS_QC/AF_GRCh37/AF_GRCh37_TI_RawCounts_HeatScree.pdf", width=10, height=7)
heat.scree(Loadings, Importance, 2.5, 2.7)
dev.off()
...
pdf("RAW_COUNTS_QC/AF_GRCh37/AF_GRCh37_SC_RawCounts_HeatScree.pdf", width=10, height=7)
heat.scree(Loadings, Importance, 2.5, 2.7)
dev.off()
...
pdf("RAW_COUNTS_QC/AF_GRCh37/AF_GRCh37_DUO_RawCounts_HeatScree.pdf", width=10, height=7)
heat.scree(Loadings, Importance, 2.5, 2.7)
dev.off()
...
#save(howell.dds.ti,howell.vst.ti,factors.howell.ti,howell.dds.sc,howell.vst.sc,factors.howell.sc,howell.dds.ac,howell.vst.ac,factors.howell.ac,file="RAW_COUNTS_QC/HOWELL_GRCh37/Howell_GRCh37_ByTissue_RawDataQCInput.RData")


# RE UNDIFFERENTIATED DATASETS:
# Given there are only 6 SC samples, it probably doesn't make much sense to normalise these separately, however, run for the sake of completeness
...
save(re.dds.ti,re.vst.ti,re.factors.ti,re.dds.sc,re.vst.sc,re.factors.sc,re.dds,re.vst,re.factors,file="RAW_COUNTS_QC/RE_GRCh37/RE_GRCh37_ByTissue_RawDataQCInput.RData")
...
save(af.dds.ti,af.vst.ti,af.factors.ti,af.dds.sc,af.vst.sc,af.factors.sc,af.dds.duo,af.vst.duo,af.factors.duo,af.dds,af.vst,af.factors,file="RAW_COUNTS_QC/AF_GRCh37/AF_GRCh37_ByTissue_RawDataQCInput.RData")
...
readme.howell.norm <- data.frame(Dataset=c("howell.ti","pheno.howell.ti","howell.sc","pheno.howell.sc","howell.ac","pheno.howell.ac","info"),Description=c("E-MTAB-5464 (Howell) normalised TI counts (n=32)","Howell TI sample info, updated 29Sep22","E-MTAB-5464 (Howell) normalised SC counts (n=32)","Howell SC sample info, updated 29Sep22","E-MTAB-5464 (Howell) normalised AC counts (n=12)","Howell AC sample info, updated 29Sep22","Ensembl GRCh37 release 107 gene annotation info"))
save(howell.ti,pheno.howell.ti,howell.sc,pheno.howell.sc,howell.ac,pheno.howell.ac,info,readme.howell.norm,file="NORMALISED_COUNTS/Howell_GRCh37_ByTissue_NormalisedCounts.RData")
...
readme.re.norm <- data.frame(Dataset=c("re","pheno.re","re.ti","pheno.re.ti","re.sc","pheno.re.sc","info"),Description=c("NGS-K.Nayak-40706 (RE) undifferentiated normalised counts (n=30)","RE sample info, updated 24Oct22","NGS-K.Nayak-40706 (RE) undifferentiated normalised TI counts (n=24)","RE TI sample info, updated 24Oct22","NGS-K.Nayak-40706 (RE) undifferentiated normalised SC counts (n=6)","RE SC sample info, updated 24Oct22","Ensembl GRCh37 release 107 gene annotation info"))
save(re,pheno.re,re.ti,pheno.re.ti,re.sc,pheno.re.sc,info,readme.re.norm,file="NORMALISED_COUNTS/RE_GRCh37_ByTissue_NormalisedCounts.RData")
...
readme.af.norm <- data.frame(Dataset=c("af","pheno.af","af.ti","pheno.af.ti","af.sc","pheno.af.sc","af.duo","pheno.af.duo","info"),Description=c("NGS-K.Nayak-40750 (AF) normalised counts (n=90)","AF sample info, updated 24Oct22","NGS-K.Nayak-40750 (AF) normalised TI counts (n=30)","AF TI sample info, updated 24Oct22","NGS-K.Nayak-40750 (AF) normalised SC counts (n=30)","AF SC sample info, updated 24Oct22","NGS-K.Nayak-40750 (AF) normalised DUO counts (n=30)","AF DUO sample info, updated 24Oct22","Ensembl GRCh37 release 107 gene annotation info"))
save(af,pheno.af,af.ti,pheno.af.ti,af.sc,pheno.af.sc,af.duo,pheno.af.duo,info,readme.af.norm,file="NORMALISED_COUNTS/AF_GRCh37_ByTissue_NormalisedCounts.RData")
...
save(re,pheno.re,re.ti,pheno.re.ti,re.sc,pheno.re.sc,info,readme.re.norm,file="NORMALISED_COUNTS/RE_GRCh37_ByTissue_NormalisedCounts.RData")
write.table(pheno.re, "NORMALISED_COUNTS/RE_GRCh37_UndifferentiatedSamples_AverageMHCIExpression.txt", row.names=F, sep="\t", quote=F)
...
save(af,pheno.af,af.ti,pheno.af.ti,af.sc,pheno.af.sc,af.duo,pheno.af.duo,info,readme.af.norm,file="NORMALISED_COUNTS/AF_GRCh37_ByTissue_NormalisedCounts.RData")
write.table(pheno.af, "NORMALISED_COUNTS/AF_GRCh37_AverageMHCIExpression.txt", row.names=F, sep="\t", quote=F)
...
write.table(pca, "NORMALISED_COUNTS_QC/HOWELL_GRCh37/Howell_GRCh37_TI_MetaData_PCs.txt", row.names=F, sep="\t", quote=F)

pdf("NORMALISED_COUNTS_QC/HOWELL_GRCh37/Howell_GRCh37_TI_NormalisedCounts_PC1vPC2.pdf", width=10, height=5)
...
write.table(pca, "NORMALISED_COUNTS_QC/HOWELL_GRCh37/Howell_GRCh37_SC_MetaData_PCs.txt", row.names=F, sep="\t", quote=F)

pdf("NORMALISED_COUNTS_QC/HOWELL_GRCh37/Howell_GRCh37_SC_NormalisedCounts_PC1vPC2.pdf", width=10, height=5)
p1 <- ggplot(pca, aes(PC1, PC2, fill=diagnosis))
p2 <- ggplot(pca, aes(PC1, PC2, fill=sex))
grid.arrange(p1+geom_point(shape=21,size=2,color="black")+theme_bw()+theme(legend.title=element_text(face="bold"))+fillscale_diagnosis6,p2+geom_point(shape=21,size=2,color="black")+theme_bw()+theme(legend.title=element_text(face="bold"))+scale_fill_manual(name="Sex",values=c("red","blue"),labels=c("F","M")),ncol=2)
dev.off()
...
write.table(pca, "NORMALISED_COUNTS_QC/HOWELL_GRCh37/Howell_GRCh37_AC_MetaData_PCs.txt", row.names=F, sep="\t", quote=F)

pdf("NORMALISED_COUNTS_QC/HOWELL_GRCh37/Howell_GRCh37_AC_NormalisedCounts_PC1vPC2.pdf", width=10, height=5)
p1 <- ggplot(pca, aes(PC1, PC2, fill=diagnosis))
p2 <- ggplot(pca, aes(PC1, PC2, fill=sex))
grid.arrange(p1+geom_point(shape=21,size=2,color="black")+theme_bw()+theme(legend.title=element_text(face="bold"))+fillscale_diagnosis6,p2+geom_point(shape=21,size=2,color="black")+theme_bw()+theme(legend.title=element_text(face="bold"))+scale_fill_manual(name="Sex",values=c("red","blue"),labels=c("F","M")),ncol=2)
dev.off()
...
write.table(r.pca, "NORMALISED_COUNTS_QC/RE_GRCh37/RE_GRCh37_UndifferentiatedALL_MetaData_PCs.txt", row.names=F, sep="\t", quote=F)

pdf("NORMALISED_COUNTS_QC/RE_GRCh37/RE_GRCh37_UndifferentiatedALL_NormalisedCounts_PC1vPC2.pdf", width=15, height=5)
...
write.table(pca, "NORMALISED_COUNTS_QC/RE_GRCh37/RE_GRCh37_UndifferentiatedTI_MetaData_PCs.txt", row.names=F, sep="\t", quote=F)

pdf("NORMALISED_COUNTS_QC/RE_GRCh37/RE_GRCh37_UndifferentiatedTI_NormalisedCounts_PC1vPC2.pdf", width=10, height=10)
p1 <- ggplot(pca, aes(PC1, PC2, fill=diagnosis))
...
write.table(pca, "NORMALISED_COUNTS_QC/RE_GRCh37/RE_GRCh37_UndifferentiatedSC_MetaData_PCs.txt", row.names=F, sep="\t", quote=F)

pdf("NORMALISED_COUNTS_QC/RE_GRCh37/RE_GRCh37_UndifferentiatedSC_NormalisedCounts_PC1vPC2.pdf", width=10, height=10)
p1 <- ggplot(pca, aes(PC1, PC2, fill=diagnosis))
p2 <- ggplot(pca, aes(PC1, PC2, fill=treatment))
p4 <- ggplot(pca, aes(PC1, PC2, fill=passage))
p6 <- ggplot(pca, aes(PC1, PC2, fill=sex))
...
pdf("NORMALISED_COUNTS_QC/AF_GRCh37/AF_GRCh37_ALL_NormalisedCounts_PC1vPC2.pdf", width=15, height=5)
...
write.table(pca, "NORMALISED_COUNTS_QC/AF_GRCh37/AF_GRCh37_TI_MetaData_PCs.txt", row.names=F, sep="\t", quote=F)

pdf("NORMALISED_COUNTS_QC/AF_GRCh37/AF_GRCh37_TI_NormalisedCounts_PC1vPC2.pdf", width=15, height=5)
p1 <- ggplot(pca, aes(PC1, PC2, fill=diagnosis))
p2 <- ggplot(pca, aes(PC1, PC2, fill=treatment))
...
write.table(pca, "NORMALISED_COUNTS_QC/AF_GRCh37/AF_GRCh37_SC_MetaData_PCs.txt", row.names=F, sep="\t", quote=F)

pdf("NORMALISED_COUNTS_QC/AF_GRCh37/AF_GRCh37_SC_NormalisedCounts_PC1vPC2.pdf", width=15, height=5)
p1 <- ggplot(pca, aes(PC1, PC2, fill=diagnosis))
p2 <- ggplot(pca, aes(PC1, PC2, fill=treatment))
p3 <- ggplot(pca, aes(PC1, PC2, fill=sex))
grid.arrange(p1+geom_point(shape=21,size=2,color="black")+theme_bw()+theme(legend.title=element_text(face="bold"))+fillscale_diagnosis2,p2+geom_point(shape=21,size=2,color="black")+theme_bw()+theme(legend.title=element_text(face="bold"))+fillscale_treat,p3+geom_point(shape=21,size=2,color="black")+theme_bw()+theme(legend.title=element_text(face="bold"))+scale_fill_manual(name="Sex",values=c("red","blue"),labels=c("F","M")),ncol=3)
...
write.table(pca, "NORMALISED_COUNTS_QC/AF_GRCh37/AF_GRCh37_DUO_MetaData_PCs.txt", row.names=F, sep="\t", quote=F)

pdf("NORMALISED_COUNTS_QC/AF_GRCh37/AF_GRCh37_DUO_NormalisedCounts_PC1vPC2.pdf", width=10, height=10)
p1 <- ggplot(pca, aes(PC1, PC2, fill=diagnosis))
p2 <- ggplot(pca, aes(PC1, PC2, fill=treatment))
p3 <- ggplot(pca, aes(PC1, PC2, fill=sex))
grid.arrange(p1+geom_point(shape=21,size=2,color="black")+theme_bw()+theme(legend.title=element_text(face="bold"))+fillscale_diagnosis2,p2+geom_point(shape=21,size=2,color="black")+theme_bw()+theme(legend.title=element_text(face="bold"))+fillscale_treat,p3+geom_point(shape=21,size=2,color="black")+theme_bw()+theme(legend.title=element_text(face="bold"))+scale_fill_manual(name="Sex",values=c("red","blue"),labels=c("F","M")),ncol=3)
...
pdf("NORMALISED_COUNTS_QC/HOWELL_GRCh37/Howell_GRCh37_TI_NormalisedCounts_HeatScree.pdf", width=10, height=6)
heat.scree(Loadings, Importance, 2.5, 2.7)
dev.off()
...
pdf("NORMALISED_COUNTS_QC/HOWELL_GRCh37/Howell_GRCh37_SC_NormalisedCounts_HeatScree.pdf", width=10, height=6)
heat.scree(Loadings, Importance, 2.5, 2.7)
dev.off()
...
pdf("NORMALISED_COUNTS_QC/HOWELL_GRCh37/Howell_GRCh37_AC_NormalisedCounts_HeatScree.pdf", width=10, height=6)
heat.scree(Loadings, Importance, 2.5, 2.7)
dev.off()
...
pdf("NORMALISED_COUNTS_QC/RE_GRCh37/RE_GRCh37_UndifferentiatedALL_NormalisedCounts_HeatScree.pdf", width=10, height=7)
heat.scree(Loadings, Importance, 2.5, 2.7)
dev.off()
...
pdf("NORMALISED_COUNTS_QC/RE_GRCh37/RE_GRCh37_UndifferentiatedTI_NormalisedCounts_HeatScree.pdf", width=10, height=7)
heat.scree(Loadings, Importance, 2.5, 2.7)
dev.off()
...
pdf("NORMALISED_COUNTS_QC/AF_GRCh37/AF_GRCh37_ALL_NormalisedCounts_HeatScree.pdf", width=10, height=7)
heat.scree(Loadings, Importance, 2.5, 2.7)
dev.off()
...
pdf("NORMALISED_COUNTS_QC/AF_GRCh37/AF_GRCh37_TI_NormalisedCounts_HeatScree.pdf", width=10, height=7)
heat.scree(Loadings, Importance, 2.5, 2.7)
dev.off()
...
pdf("NORMALISED_COUNTS_QC/AF_GRCh37/AF_GRCh37_SC_NormalisedCounts_HeatScree.pdf", width=10, height=7)
heat.scree(Loadings, Importance, 2.5, 2.7)
dev.off()
...
pdf("NORMALISED_COUNTS_QC/AF_GRCh37/AF_GRCh37_DUO_NormalisedCounts_HeatScree.pdf", width=10, height=7)
heat.scree(Loadings, Importance, 2.5, 2.7)
dev.off()
...
pdf("NORMALISED_COUNTS_QC/HOWELL_GRCh37/Howell_GRCh37_TI_SexLinkedGenes_EuclideanAverageClustering.pdf", width=20, height=11)
par(mar=c(10,7,2,4))
plot(dend)
...
pdf("NORMALISED_COUNTS_QC/HOWELL_GRCh37/Howell_GRCh37_SC_SexLinkedGenes_EuclideanAverageClustering.pdf", width=20, height=11)
par(mar=c(10,7,2,4))
plot(dend)
colored_bars(colors=cbind(Diagnosis,Sex), dend=dend, rowLabels=c("Diagnosis","Sex"))
dev.off()
...
pdf("NORMALISED_COUNTS_QC/HOWELL_GRCh37/Howell_GRCh37_AC_SexLinkedGenes_EuclideanAverageClustering.pdf", width=15, height=11)
par(mar=c(10,7,2,4))
plot(dend)
colored_bars(colors=cbind(Diagnosis,Sex), dend=dend, rowLabels=c("Diagnosis","Sex"))
dev.off()
...
pdf("NORMALISED_COUNTS_QC/RE_GRCh37/RE_GRCh37_UndifferentiatedTI_SexLinkedGenes_EuclideanAverageClustering.pdf", width=20, height=11)
par(mar=c(10,7,2,4))
plot(dend)
colored_bars(colors=cbind(Diagnosis,Sex), dend=dend, rowLabels=c("Diagnosis","Sex"))
dev.off()
...
pdf("NORMALISED_COUNTS_QC/RE_GRCh37/RE_GRCh37_UndifferentiatedSC_SexLinkedGenes_EuclideanAverageClustering.pdf", width=10, height=11)
par(mar=c(10,7,2,4))
plot(dend)
colored_bars(colors=cbind(Diagnosis,Sex), dend=dend, rowLabels=c("Diagnosis","Sex"))
dev.off()
...
pdf("NORMALISED_COUNTS_QC/AF_GRCh37/AF_GRCh37_TI_SexLinkedGenes_EuclideanAverageClustering.pdf", width=20, height=11)
par(mar=c(10,7,2,4))
plot(dend)
colored_bars(colors=cbind(Diagnosis,Sex), dend=dend, rowLabels=c("Diagnosis","Sex"))
dev.off()
...
pdf("NORMALISED_COUNTS_QC/AF_GRCh37/AF_GRCh37_SC_SexLinkedGenes_EuclideanAverageClustering.pdf", width=20, height=11)
par(mar=c(10,7,2,4))
plot(dend)
colored_bars(colors=cbind(Diagnosis,Sex), dend=dend, rowLabels=c("Diagnosis","Sex"))
dev.off()
...
pdf("NORMALISED_COUNTS_QC/AF_GRCh37/AF_GRCh37_DUO_SexLinkedGenes_EuclideanAverageClustering.pdf", width=20, height=11)
par(mar=c(10,7,2,4))
plot(dend)
colored_bars(colors=cbind(Diagnosis,Sex), dend=dend, rowLabels=c("Diagnosis","Sex"))
dev.off()

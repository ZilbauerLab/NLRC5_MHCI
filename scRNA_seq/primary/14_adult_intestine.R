...
intestine_epi_h5ad <- Convert(here("/media/redgar/Seagate Portable Drive/adult_intestine/epi_log_counts02_v2.h5ad"), ".h5seurat", overwrite= TRUE)
#intestine_epi_h5ad <- Convert(here("../EBI/MHCI/more_single_cell/epi_log_counts02_v2.h5ad"), ".h5seurat", overwrite= TRUE)

intestine_epi <- LoadH5Seurat(intestine_epi_h5ad, assays = "RNA")

print(dim(intestine_epi))
print(intestine_epi)
